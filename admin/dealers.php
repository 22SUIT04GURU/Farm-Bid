  ...
  <div class="row">
    ...
    <div class="col-md-3 col-lg-2 px-0 position-fixed h-100 bg-dark shadow-sm sidebar" id="sidebar">
      ...
      <div class="list-group rounded-0 bg-dark">
        ...
        <a href="dealers.php" class="list-group-item list-group-item-action border-0 align-items-center active">
          <span class="bi bi-person"></span>
    ...
    <div class="col-md-9 col-lg-10 ml-md-auto px-0 h-100" >
    	<div class="jumbotron jumbotron-fluid rounded bg-white border-0 shadow-sm border-left px-4">
		  <div class="container">
    		<h1 class="mb-2 text-success">Tech Farm Bid - <span class="text-primary">Dealers</span></h1>
...
<div class="col-lg-12 grid-margin stretch-card">
           ...
           $sql = "SELECT * FROM user_tbl WHERE role = 'dealer'";
